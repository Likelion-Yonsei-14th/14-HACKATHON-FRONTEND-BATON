...
export const mockApiClient: BatonApiClient = {
    ...
    const branches: Branch[] = [
      {
        ...
        conditionText: '상대방이 제안을 수락하거나 동의하는 경우',
        decisionText: '제안대로 진행하기로 확정',
      ...
      },
      {
        ...
        conditionText: '상대방이 조건을 달거나 추가 정보를 요청하는 경우',
        decisionText: '요청한 조건/정보를 확인 후 다시 공유',
      ...
      },
      {
        ...
        conditionText: '상대방이 거절하거나 판단을 미루는 경우',
        decisionText: '대안 일정/담당자 안내로 전환',
  ...
  async createBranch(batonId, draft) {
    ...
    const branch: Branch = {
      ...
      name: draft.name,
      description: null,
      conditionText: draft.name,
      decisionText: draft.name,
      responseText: '',
      executionMode: 'AUTO',

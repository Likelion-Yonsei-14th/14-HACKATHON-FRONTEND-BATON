  ...
  return (
    <AppShell>
      ...
      <div className="mt-4 flex max-w-3xl flex-col gap-4">
          ...
          <Panel key={branch.id}>
            <div className="flex items-start justify-between gap-3">
              ...
              {pendingDeleteId === branch.id ? (
                ...
                <button
                  className="font-suit shrink-0 text-[13px] text-muted-2 hover:text-red-500"
        ...
        <button
          className="font-suit w-fit rounded-[6px] border border-dashed border-border px-4 py-2 text-sm font-semibold text-muted-2 transition hover:border-primary hover:text-primary disabled:opacity-40"
          disabled={adding}

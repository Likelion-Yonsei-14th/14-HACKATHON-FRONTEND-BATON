  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex flex-col items-center gap-5 px-8 py-24 text-center">
        <div className="flex size-[59px] items-center justify-center rounded-full bg-warn-soft shadow-hairline">
          <span className="text-2xl">⚡</span>
        </div>
        <h1 className="font-suit text-2xl font-medium text-strong">Slack 연결에 실패했습니다</h1>
        <p className="font-suit max-w-md text-base text-muted">
          Slack 인증 과정에서 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.
        </p>
        <div className="mt-2 flex items-center gap-4">
          <Link className="font-suit text-sm text-muted hover:text-body" to="/">
            홈으로 돌아가기
          </Link>

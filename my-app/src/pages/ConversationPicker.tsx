...
export function ConversationPicker() {
  ...
  return (
    <AppShell>
      <h1 className="font-suit text-2xl font-medium text-strong">대화 선택</h1>
      <p className="font-suit mt-2 text-muted">바통을 만들 Slack 채널 또는 DM을 선택하세요.</p>

      <div className="mt-6 flex gap-4">
        <input
          className="font-suit h-11 w-full max-w-lg rounded-full bg-chip px-5 text-sm text-body shadow-hairline outline-none"
